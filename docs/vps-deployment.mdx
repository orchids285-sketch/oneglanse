...
The app ports (3000, 5432, 8123, 6379) stay internal. Port `3333` must remain reachable from your local machine because `pnpm upload:vps` sends provider sessions to `http://YOUR_VPS_IP:3333/auth/sessions`.
