...
export const formChipClassName =
	"max-w-full rounded-full border border-gray-200/80 bg-stone-50 px-4 py-2 text-left text-xs text-gray-700 transition hover:bg-white dark:border-gray-800 dark:bg-gray-900 dark:text-gray-300 dark:hover:bg-gray-950";

export const formDialogContentClassName =
	"min-w-0 w-full max-w-[min(100vw-1rem,32rem)] overflow-hidden rounded-[16px] border border-transparent bg-white p-0 shadow-[0_12px_34px_-24px_rgba(0,0,0,0.22)] dark:border-transparent dark:bg-neutral-950 dark:shadow-[0_14px_36px_-24px_rgba(0,0,0,0.58)]";
...
export const formDialogSupportCardClassName =
	"rounded-[14px] bg-stone-50/90 px-4 py-3 text-left shadow-[0_14px_30px_-28px_rgba(15,23,42,0.18)] dark:bg-neutral-900/80 dark:shadow-[0_14px_30px_-28px_rgba(0,0,0,0.4)]";
