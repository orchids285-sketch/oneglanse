...
export function BrandPerceptionCard({
	...
	return (
		<Card className="flex h-full min-h-[500px] flex-col rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-black">
			<div>
			...
			{!hasData ? (
				...
				<div className="flex flex-1 flex-col gap-4">
					{pricingPerception !== "not_mentioned" && (
						<div className="ui-list-item rounded-xl border border-gray-200 bg-white px-3.5 py-3 dark:border-gray-800 dark:bg-black">
						...
						<div>
							...
							<div className="flex flex-wrap gap-2">
								{differentiators.slice(0, 5).map((diff) => (
									<span
										key={diff}
										className="ui-list-item rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-[11px] font-semibold text-muted-foreground dark:border-gray-700 dark:bg-neutral-900"
									>
